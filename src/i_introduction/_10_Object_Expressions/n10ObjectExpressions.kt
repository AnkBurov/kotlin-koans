...
object DecendingComparator: Comparator<Int> {
...
fun task10(): List<Int> {
    val arrayList: ArrayList<Int> = arrayListOf(1, 5, 2)
    arrayList.sortWith(DecendingComparator)
//    Collections.sort(arrayList, DecendingComparator)
    return arrayList
}